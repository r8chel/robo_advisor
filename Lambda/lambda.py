    ...
    if age is not None:
        ...
        if age < 0:
            return build_validation_result(
                False,
                "age",
                "Please enter a number greater than 0 and less than 65",
            )
        elif age >= 65:
            return build_validation_result(
                False,
                "age",
                "The maximum age to retire is 64, ",
            )
...
def recommend_portfolio(intent_request):
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """{}, based on your prefered risk level, 
            my recommendation is an investment portfolio with {}
            """.format(
